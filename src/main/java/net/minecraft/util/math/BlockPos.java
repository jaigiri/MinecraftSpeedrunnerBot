...
public class BlockPos extends Vector3i {
	public static final Codec<BlockPos> CODEC = Codec.INT_STREAM.comapFlatMap((p_239586_0_) -> Util.validateIntStreamSize(p_239586_0_, 3).map((p_239587_0_) -> new BlockPos(p_239587_0_[0], p_239587_0_[1], p_239587_0_[2])), (p_239582_0_) -> IntStream.of(p_239582_0_.getX(), p_239582_0_.getY(), p_239582_0_.getZ())).stable();
