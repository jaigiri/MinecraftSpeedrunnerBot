...
public class IngameGui extends AbstractGui {
   ...
   public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
      ...
      if (this.mc.gameSettings.getPointOfView().isFirstPerson() && itemstack.getItem() == Blocks.CARVED_PUMPKIN.asItem()) {
   ...
   private void func_238456_d_(MatrixStack p_238456_1_) {
      ...
      if (gamesettings.getPointOfView().isFirstPerson()) {
   ...
   public void func_238450_a_(ChatType p_238450_1_, ITextComponent p_238450_2_, UUID p_238450_3_) {
      if (this.mc.canSendChatMessages(p_238450_3_)) {
         if (!this.mc.gameSettings.field_244794_ae || this.mc.canSendChatMessages(this.func_244795_b(p_238450_2_))) {
