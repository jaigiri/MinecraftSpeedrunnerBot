...
public class IronGolemEntity extends GolemEntity implements IAngerable {
	...
	public Vector3d func_241205_ce_() {
		return new Vector3d(0.0D, 0.875F * this.getEyeHeight(), this.getWidth() * 0.4F);
	}
	...
	public enum Cracks {
		...
		private static final List<IronGolemEntity.Cracks> field_226513_e_ = Stream.of(values()).sorted(Comparator.comparingDouble((p_226516_0_) -> p_226516_0_.field_226514_f_)).collect(ImmutableList.toImmutableList());
