...
public class Vector3i implements Comparable<Vector3i> {
   public static final Codec<Vector3i> CODEC = Codec.INT_STREAM.comapFlatMap((p_239783_0_) -> Util.validateIntStreamSize(p_239783_0_, 3).map((p_239784_0_) -> new Vector3i(p_239784_0_[0], p_239784_0_[1], p_239784_0_[2])), (p_239782_0_) -> IntStream.of(p_239782_0_.getX(), p_239782_0_.getY(), p_239782_0_.getZ()));
