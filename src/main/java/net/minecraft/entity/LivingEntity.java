...
import com.daytrip.event.impl.EventEntityDeath;
...
public abstract class LivingEntity extends Entity {
	...
	public void onDeath(DamageSource cause) {
		if (!this.removed && !this.dead) {
			EventEntityDeath eventEntityDeath = new EventEntityDeath();
			eventEntityDeath.deadEntity = this;
			eventEntityDeath.deathSource = cause;
			eventEntityDeath.attacker = this.getAttackingEntity();
			Events.post(eventEntityDeath);
