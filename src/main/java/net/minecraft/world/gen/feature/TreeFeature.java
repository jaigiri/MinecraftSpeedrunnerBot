...
public class TreeFeature extends Feature<BaseTreeFeatureConfig> {
   ...
   public final boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, BaseTreeFeatureConfig config) {
      // System.out.println("Tree was generated at: " + pos);
      ...
      if (mutableboundingbox.minX <= mutableboundingbox.maxX && flag && !set.isEmpty()) {
         if (!config.decorators.isEmpty()) {
            ...
            config.decorators.forEach((p_236405_6_) -> p_236405_6_.func_225576_a_(reader, rand, list, list1, set2, mutableboundingbox));
         }
