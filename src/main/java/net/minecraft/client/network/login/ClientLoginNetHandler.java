...
public class ClientLoginNetHandler implements IClientLoginNetHandler {
   ...
   public void onDisconnect(ITextComponent reason) {
      if (this.previousGuiScreen != null && this.previousGuiScreen instanceof RealmsScreen) {
         this.mc.showScreen(new DisconnectedRealmsScreen(this.previousGuiScreen, DialogTexts.CONNECTION_FAILED, reason));
      } else {
         this.mc.showScreen(new DisconnectedScreen(this.previousGuiScreen, DialogTexts.CONNECTION_FAILED, reason));
      }
