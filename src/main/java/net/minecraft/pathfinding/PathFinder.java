...
public class PathFinder {
	...
	private Path func_227479_a_(PathPoint p_227479_1_, Map<FlaggedPathPoint, BlockPos> p_227479_2_, float p_227479_3_, int p_227479_4_, float p_227479_5_) {
		...
		Optional<Path> optional = !set2.isEmpty() ? set2.stream().map((p_224778_2_) -> this.func_224780_a(p_224778_2_.func_224763_d(), p_227479_2_.get(p_224778_2_), true)).min(Comparator.comparingInt(Path::getCurrentPathLength)) : set.stream().map((p_224777_2_) -> this.func_224780_a(p_224777_2_.func_224763_d(), p_227479_2_.get(p_224777_2_), false)).min(Comparator.comparingDouble(Path::func_224769_l).thenComparingInt(Path::getCurrentPathLength));
