...
public abstract class AbstractBlock {
	...
	public float getPlayerRelativeBlockHardness(BlockState state, PlayerEntity player, IBlockReader worldIn, BlockPos pos) {
		float f = state.getBlockHardness();
		if (f == -1.0F) {
			return 0.0F;
		} else {
	...
	public abstract static class AbstractBlockState extends StateHolder<Block, BlockState> {
		...
		static final class Cache {
			...
			private Cache(BlockState stateIn) {
				...
				this.isCollisionShapeLargerThanFullBlock = Arrays.stream(Direction.Axis.values()).anyMatch((p_235796_1_) -> this.collisionShape.getStart(p_235796_1_) < 0.0D || this.collisionShape.getEnd(p_235796_1_) > 1.0D);
	...
	public static class Properties {
		...
		private ToIntFunction<BlockState> lightLevel = (p_235830_0_) -> 0;
		...
		private AbstractBlock.IExtendedPositionPredicate<EntityType<?>> allowsSpawn = (p_235832_0_, p_235832_1_, p_235832_2_, p_235832_3_) -> p_235832_0_.isSolidSide(p_235832_1_, p_235832_2_, Direction.UP) && p_235832_0_.getLightValue() < 14;
		private AbstractBlock.IPositionPredicate isOpaque = (p_235853_0_, p_235853_1_, p_235853_2_) -> p_235853_0_.getMaterial().isOpaque() && p_235853_0_.hasOpaqueCollisionShape(p_235853_1_, p_235853_2_);
		private AbstractBlock.IPositionPredicate suffocates = (p_235848_1_, p_235848_2_, p_235848_3_) -> this.material.blocksMovement() && p_235848_1_.hasOpaqueCollisionShape(p_235848_2_, p_235848_3_);
		private AbstractBlock.IPositionPredicate blocksVision = this.suffocates;
		private AbstractBlock.IPositionPredicate needsPostProcessing = (p_235843_0_, p_235843_1_, p_235843_2_) -> false;
		private AbstractBlock.IPositionPredicate emmissiveRendering = (p_235831_0_, p_235831_1_, p_235831_2_) -> false;
