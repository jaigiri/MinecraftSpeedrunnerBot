...
public class PathfindingDebugRenderer implements DebugRenderer.IDebugRenderer {
	...
	private static void func_229034_b_(Path p_229034_0_, float p_229034_1_, boolean p_229034_2_, boolean p_229034_3_, double p_229034_4_, double p_229034_6_, double p_229034_8_) {
		...
		if (func_229033_a_(blockpos, p_229034_4_, p_229034_6_, p_229034_8_) <= 80.0F) {
			DebugRenderer.renderBox((new AxisAlignedBB((float) blockpos.getX() + 0.25F, (float) blockpos.getY() + 0.25F, (double) blockpos.getZ() + 0.25D, (float) blockpos.getX() + 0.75F, (float) blockpos.getY() + 0.75F, (float) blockpos.getZ() + 0.75F)).offset(-p_229034_4_, -p_229034_6_, -p_229034_8_), 0.0F, 1.0F, 0.0F, 0.5F);
		...
		if (p_229034_2_) {
			for (PathPoint pathpoint2 : p_229034_0_.getClosedSet()) {
				if (func_229033_a_(pathpoint2.func_224759_a(), p_229034_4_, p_229034_6_, p_229034_8_) <= 80.0F) {
					DebugRenderer.renderBox((new AxisAlignedBB((float) pathpoint2.x + 0.5F - p_229034_1_ / 2.0F, (float) pathpoint2.y + 0.01F, (float) pathpoint2.z + 0.5F - p_229034_1_ / 2.0F, (float) pathpoint2.x + 0.5F + p_229034_1_ / 2.0F, (double) pathpoint2.y + 0.1D, (float) pathpoint2.z + 0.5F + p_229034_1_ / 2.0F)).offset(-p_229034_4_, -p_229034_6_, -p_229034_8_), 1.0F, 0.8F, 0.8F, 0.5F);
				}
			}
