      ...
      if (this.isInvulnerableTo(source)) {
         ...
         if (!flag && this.respawnInvulnerabilityTicks > 0 && source != DamageSource.OUT_OF_WORLD) {
            ...
            if (source instanceof EntityDamageSource) {
               ...
               if (entity instanceof PlayerEntity && this.cannotAttackPlayer((PlayerEntity) entity)) {
                  return false;
               }
               ...
               if (entity instanceof AbstractArrowEntity) {
                  ...
                  if (entity1 instanceof PlayerEntity && this.cannotAttackPlayer((PlayerEntity) entity1)) {
                     return false;
                  }
               }
            }
