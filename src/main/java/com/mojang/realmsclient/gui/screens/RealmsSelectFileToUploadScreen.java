...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      try {
         ...
         this.minecraft.showScreen(new RealmsGenericErrorScreen(new StringTextComponent("Unable to load worlds"), ITextComponent.getTextComponentOrEmpty(exception.getMessage()), this.field_224548_b));
         return;
      }
      ...
      this.addButton(new Button(this.width / 2 + 6, this.height - 32, 153, 20, DialogTexts.GUI_BACK, (p_237973_1_) -> {
         this.minecraft.showScreen(this.field_224548_b);
      }));
   ...
   private void func_224544_b() {
      if (this.field_224554_h != -1 && !this.field_224553_g.get(this.field_224554_h).isHardcoreModeEnabled()) {
         ...
         this.minecraft.showScreen(new RealmsUploadScreen(this.field_224549_c, this.field_224550_d, this.field_224548_b, worldsummary, this.field_237967_A_));
      }
