...
public class MapItemRenderer implements AutoCloseable {
	...
	private static final RenderType field_228085_d_ = RenderType.getTexture(TEXTURE_MAP_ICONS);
	...
	public void renderMap(MatrixStack p_228086_1_, IRenderTypeBuffer p_228086_2_, MapData p_228086_3_, boolean p_228086_4_, int p_228086_5_) {
		this.getMapRendererInstance(p_228086_3_).render(p_228086_1_, p_228086_2_, p_228086_4_, p_228086_5_);
	}
	...
	class Instance implements AutoCloseable {
		...
		private Instance(MapData mapdataIn) {
			...
			ResourceLocation resourcelocation = textureManager.getDynamicTextureLocation("map/" + mapdataIn.getName(), this.mapTexture);
			this.field_228088_d_ = RenderType.getTexture(resourcelocation);
		}
		...
		private void render(MatrixStack p_228089_1_, IRenderTypeBuffer p_228089_2_, boolean p_228089_3_, int p_228089_4_) {
			...
			for (MapDecoration mapdecoration : this.mapData.mapDecorations.values()) {
				if (!p_228089_3_ || mapdecoration.renderOnFrame()) {
					...
					if (mapdecoration.getCustomName() != null) {
						...
						p_228089_1_.translate(0.0D, 0.0D, -0.1F);
