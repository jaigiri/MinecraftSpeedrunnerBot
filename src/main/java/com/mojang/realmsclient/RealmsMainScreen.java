...
public class RealmsMainScreen extends RealmsScreen {
   ...
   private static final ResourceLocation ON_ICON = new ResourceLocation("realms", "textures/gui/realms/on_icon.png");
   private static final ResourceLocation OFF_ICON = new ResourceLocation("realms", "textures/gui/realms/off_icon.png");
   private static final ResourceLocation EXPIRED_ICON = new ResourceLocation("realms", "textures/gui/realms/expired_icon.png");
   private static final ResourceLocation EXPIRES_SOON_ICON = new ResourceLocation("realms", "textures/gui/realms/expires_soon_icon.png");
   private static final ResourceLocation LEAVE_ICON = new ResourceLocation("realms", "textures/gui/realms/leave_icon.png");
   ...
   private static final ResourceLocation INVITE_ICON = new ResourceLocation("realms", "textures/gui/realms/invite_icon.png");
   private static final ResourceLocation WORLD_ICON = new ResourceLocation("realms", "textures/gui/realms/world_icon.png");
   private static final ResourceLocation REALMS = new ResourceLocation("realms", "textures/gui/title/realms.png");
   private static final ResourceLocation CONFIGURE_ICON = new ResourceLocation("realms", "textures/gui/realms/configure_icon.png");
   private static final ResourceLocation QUESTIONMARK = new ResourceLocation("realms", "textures/gui/realms/questionmark.png");
   private static final ResourceLocation NEWS_ICON = new ResourceLocation("realms", "textures/gui/realms/news_icon.png");
   private static final ResourceLocation POPUP = new ResourceLocation("realms", "textures/gui/realms/popup.png");
   private static final ResourceLocation DARKEN = new ResourceLocation("realms", "textures/gui/realms/darken.png");
   private static final ResourceLocation CROSS_ICON = new ResourceLocation("realms", "textures/gui/realms/cross_icon.png");
   private static final ResourceLocation TRIAL_ICON = new ResourceLocation("realms", "textures/gui/realms/trial_icon.png");
   ...
   public void init() {
      ...
      if (field_224000_H != null) {
         this.minecraft.showScreen(field_224000_H);
      } else {
   ...
   public void func_223901_c() {
      ...
      this.field_224023_l = this.addButton(new Button(this.width / 2 + 4, this.height - 32, 90, 20, DialogTexts.GUI_BACK, (p_237632_1_) -> {
         if (!this.field_224036_y) {
            this.minecraft.showScreen(this.field_224019_h);
         }
               ...
               try {
                  ...
                  if (realmsclient$compatibleversionresponse == RealmsClient.CompatibleVersionResponse.OUTDATED) {
                     ...
                     RealmsMainScreen.this.minecraft.execute(() -> {
                        RealmsMainScreen.this.minecraft.showScreen(RealmsMainScreen.field_224000_H);
                     });
                     return;
                  }
                  ...
                  if (realmsserviceexception.field_224981_a == 401) {
                     ...
                     RealmsMainScreen.this.minecraft.execute(() -> {
                        RealmsMainScreen.this.minecraft.showScreen(new RealmsGenericErrorScreen(realmsserviceexception, RealmsMainScreen.this.field_224019_h));
                     });
                  }
               }
         ...
         public void run() {
            ...
            try {
               ...
               if (obool) {
                  ...
                  RealmsMainScreen.this.minecraft.execute(() -> {
                     RealmsMainScreen.this.minecraft.showScreen(new RealmsParentalConsentScreen(RealmsMainScreen.this.field_224019_h));
                  });
               }
   ...
   private void func_223966_f(RealmsServer p_223966_1_) {
      if (this.minecraft.getSession().getPlayerID().equals(p_223966_1_.field_230588_g_) || field_224013_b) {
         this.func_223949_z();
         this.minecraft.showScreen(new RealmsConfigureWorldScreen(this, p_223966_1_.field_230582_a_));
      }
   ...
   private void func_223906_g(@Nullable RealmsServer p_223906_1_) {
      if (p_223906_1_ != null && !this.minecraft.getSession().getPlayerID().equals(p_223906_1_.field_230588_g_)) {
         ...
         this.minecraft.showScreen(new RealmsLongConfirmationScreen(this::func_237625_d_, RealmsLongConfirmationScreen.Type.Info, itextcomponent, itextcomponent1, true));
      }
         ...
         (new Thread("Realms-leave-server") {
            public void run() {
               try {
                  ...
                  RealmsMainScreen.this.minecraft.execute(() -> {
                     RealmsMainScreen.this.minecraft.showScreen(new RealmsGenericErrorScreen(realmsserviceexception, RealmsMainScreen.this));
                  });
               }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_224037_z && !this.field_223993_A && this.func_223990_b()) {
         this.minecraft.getTextureManager().bindTexture(TRIAL_ICON);
   ...
   private void func_237579_a_(MatrixStack p_237579_1_, int p_237579_2_, int p_237579_3_) {
      this.minecraft.getTextureManager().bindTexture(REALMS);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_237605_b_(MatrixStack p_237605_1_, int p_237605_2_, int p_237605_3_) {
      ...
      this.minecraft.getTextureManager().bindTexture(DARKEN);
      int l = 0;
      int k = 32;
      AbstractGui.blit(p_237605_1_, 0, 32, 0.0F, 0.0F, this.width, this.height - 40 - 32, 310, 166);
      RenderSystem.disableBlend();
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      this.minecraft.getTextureManager().bindTexture(POPUP);
   ...
   private void func_237581_a_(MatrixStack p_237581_1_, int p_237581_2_, int p_237581_3_, int p_237581_4_, int p_237581_5_, boolean p_237581_6_, boolean p_237581_7_) {
      ...
      this.minecraft.getTextureManager().bindTexture(INVITE_ICON);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   public void func_223911_a(RealmsServer p_223911_1_, Screen p_223911_2_) {
      if (p_223911_1_ != null) {
         ...
         this.minecraft.showScreen(new RealmsLongRunningMcoTaskScreen(p_223911_2_, new ConnectingToRealmsAction(this, p_223911_2_, p_223911_1_, this.field_224004_L)));
      }
   ...
   private void func_237614_c_(MatrixStack p_237614_1_, int p_237614_2_, int p_237614_3_, int p_237614_4_, int p_237614_5_) {
      this.minecraft.getTextureManager().bindTexture(EXPIRED_ICON);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_237606_b_(MatrixStack p_237606_1_, int p_237606_2_, int p_237606_3_, int p_237606_4_, int p_237606_5_, int p_237606_6_) {
      this.minecraft.getTextureManager().bindTexture(EXPIRES_SOON_ICON);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_237620_d_(MatrixStack p_237620_1_, int p_237620_2_, int p_237620_3_, int p_237620_4_, int p_237620_5_) {
      this.minecraft.getTextureManager().bindTexture(ON_ICON);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_237626_e_(MatrixStack p_237626_1_, int p_237626_2_, int p_237626_3_, int p_237626_4_, int p_237626_5_) {
      this.minecraft.getTextureManager().bindTexture(OFF_ICON);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_237630_f_(MatrixStack p_237630_1_, int p_237630_2_, int p_237630_3_, int p_237630_4_, int p_237630_5_) {
      ...
      this.minecraft.getTextureManager().bindTexture(LEAVE_ICON);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_237633_g_(MatrixStack p_237633_1_, int p_237633_2_, int p_237633_3_, int p_237633_4_, int p_237633_5_) {
      ...
      this.minecraft.getTextureManager().bindTexture(CONFIGURE_ICON);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      float f = flag ? 28.0F : 0.0F;
   ...
   private void func_237580_a_(MatrixStack p_237580_1_, int p_237580_2_, int p_237580_3_, int p_237580_4_, int p_237580_5_, boolean p_237580_6_) {
      ...
      this.minecraft.getTextureManager().bindTexture(QUESTIONMARK);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_237582_a_(MatrixStack p_237582_1_, int p_237582_2_, int p_237582_3_, boolean p_237582_4_, int p_237582_5_, int p_237582_6_, boolean p_237582_7_, boolean p_237582_8_) {
      ...
      this.minecraft.getTextureManager().bindTexture(NEWS_ICON);
      if (p_237582_8_) {
         RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      } else {
   ...
   private void func_237598_a_(Button p_237598_1_) {
      this.minecraft.showScreen(new RealmsPendingInvitesScreen(this.field_224019_h));
   }
   ...
   class CloseButton extends Button {
      ...
      public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
         RealmsMainScreen.this.minecraft.getTextureManager().bindTexture(RealmsMainScreen.CROSS_ICON);
         RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   class ServerEntry extends RealmsMainScreen.ListEntry {
      ...
      public boolean mouseClicked(double mouseX, double mouseY, int button) {
         if (this.field_223734_a.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
            ...
            RealmsMainScreen.this.minecraft.showScreen(new RealmsCreateRealmScreen(this.field_223734_a, RealmsMainScreen.this));
         } else {
      ...
      private void func_237679_b_(RealmsServer p_237679_1_, MatrixStack p_237679_2_, int p_237679_3_, int p_237679_4_, int p_237679_5_, int p_237679_6_) {
         if (p_237679_1_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
            RealmsMainScreen.this.minecraft.getTextureManager().bindTexture(RealmsMainScreen.WORLD_ICON);
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            if (RealmsMainScreen.this.func_223885_h(p_237679_1_) && p_237679_1_.field_230591_j_) {
               RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
               RenderSystem.enableBlend();
               RealmsMainScreen.this.minecraft.getTextureManager().bindTexture(RealmsMainScreen.WIDGETS);
      ...
      public void func_231401_a_(int p_231401_1_, int p_231401_2_, double p_231401_3_, double p_231401_5_, int p_231401_7_) {
         ...
         if (p_231401_2_ < RealmsMainScreen.this.field_224028_q.size()) {
            ...
            if (realmsserver != null) {
               if (realmsserver.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
                  RealmsMainScreen.this.field_224021_j = -1L;
                  Minecraft.getInstance().showScreen(new RealmsCreateRealmScreen(realmsserver, RealmsMainScreen.this));
               } else {
                  RealmsMainScreen.this.field_224021_j = realmsserver.field_230582_a_;
               }
