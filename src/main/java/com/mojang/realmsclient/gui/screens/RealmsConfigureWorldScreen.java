...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen {
   ...
   public void init() {
      ...
      this.field_224422_j = this.addButton(new Button(this.func_224374_a(0, 3), func_239562_k_(0), 100, 20, new TranslationTextComponent("mco.configure.world.buttons.players"), (p_237818_1_) -> {
         this.minecraft.showScreen(new RealmsPlayerScreen(this, this.field_224416_d));
      }));
      this.field_224423_k = this.addButton(new Button(this.func_224374_a(1, 3), func_239562_k_(0), 100, 20, new TranslationTextComponent("mco.configure.world.buttons.settings"), (p_237817_1_) -> {
         this.minecraft.showScreen(new RealmsSettingsScreen(this, this.field_224416_d.clone()));
      }));
      this.field_224424_l = this.addButton(new Button(this.func_224374_a(2, 3), func_239562_k_(0), 100, 20, new TranslationTextComponent("mco.configure.world.buttons.subscription"), (p_237816_1_) -> {
         this.minecraft.showScreen(new RealmsSubscriptionInfoScreen(this, this.field_224416_d.clone(), this.field_224415_c));
      }));
      ...
      this.field_224428_p = this.addButton(new Button(this.func_224411_b(0), func_239562_k_(13) - 5, 100, 20, new TranslationTextComponent("mco.configure.world.buttons.switchminigame"), (p_237815_1_) -> {
         ...
         this.minecraft.showScreen(realmsselectworldtemplatescreen);
      }));
      this.field_224425_m = this.addButton(new Button(this.func_224411_b(0), func_239562_k_(13) - 5, 90, 20, new TranslationTextComponent("mco.configure.world.buttons.options"), (p_237814_1_) -> {
         this.minecraft.showScreen(new RealmsSlotOptionsScreen(this, this.field_224416_d.field_230590_i_.get(this.field_224416_d.field_230595_n_).clone(), this.field_224416_d.field_230594_m_, this.field_224416_d.field_230595_n_));
      }));
      this.field_224426_n = this.addButton(new Button(this.func_224411_b(1), func_239562_k_(13) - 5, 90, 20, new TranslationTextComponent("mco.configure.world.backup"), (p_237812_1_) -> {
         this.minecraft.showScreen(new RealmsBackupScreen(this, this.field_224416_d.clone(), this.field_224416_d.field_230595_n_));
      }));
      this.field_224427_o = this.addButton(new Button(this.func_224411_b(2), func_239562_k_(13) - 5, 90, 20, new TranslationTextComponent("mco.configure.world.buttons.resetworld"), (p_237810_1_) -> {
         this.minecraft.showScreen(new RealmsResetWorldScreen(this, this.field_224416_d.clone(), () -> {
            this.minecraft.showScreen(this.func_224407_b());
         }, () -> {
            this.minecraft.showScreen(this.func_224407_b());
         }));
      }));
   ...
   private void func_224390_d() {
      ...
      this.minecraft.showScreen(this.field_224415_c);
   }
      ...
      (new Thread(() -> {
         ...
         try {
            ...
            this.minecraft.execute(() -> {
               this.minecraft.showScreen(new RealmsGenericErrorScreen(ITextComponent.getTextComponentOrEmpty(realmsserviceexception.getMessage()), this.field_224415_c));
            });
         }
   ...
   private void func_224403_a(int p_224403_1_, RealmsServer p_224403_2_) {
      ...
      this.minecraft.showScreen(new RealmsLongConfirmationScreen((p_237805_3_) -> {
         if (p_237805_3_) {
            this.minecraft.showScreen(new RealmsLongRunningMcoTaskScreen(this.field_224415_c, new SwitchMinigameRealmsAction(p_224403_2_.field_230582_a_, p_224403_1_, () -> {
               this.minecraft.showScreen(this.func_224407_b());
            })));
         } else {
   ...
   private void func_224388_b(int p_224388_1_, RealmsServer p_224388_2_) {
      ITextComponent itextcomponent = new TranslationTextComponent("mco.configure.world.slot.switch.question.line1");
      ITextComponent itextcomponent1 = new TranslationTextComponent("mco.configure.world.slot.switch.question.line2");
      this.minecraft.showScreen(new RealmsLongConfirmationScreen((p_237797_3_) -> {
         if (p_237797_3_) {
            ...
            this.minecraft.showScreen(realmsresetworldscreen);
         } else {
            this.minecraft.showScreen(this);
         }
   ...
   public void func_224386_a(RealmsWorldOptions p_224386_1_) {
      ...
      try {
         ...
         this.minecraft.showScreen(new RealmsGenericErrorScreen(realmsserviceexception, this));
         return;
      }
   ...
   public void func_237802_a_(boolean p_237802_1_, Screen p_237802_2_) {
      this.minecraft.showScreen(new RealmsLongRunningMcoTaskScreen(p_237802_2_, new OpeningWorldRealmsAction(this.field_224416_d, this, this.field_224415_c, p_237802_1_)));
   }

   public void func_237800_a_(Screen p_237800_1_) {
      this.minecraft.showScreen(new RealmsLongRunningMcoTaskScreen(p_237800_1_, new CloseRealmsAction(this.field_224416_d, this)));
   }
   ...
   protected void func_223627_a_(@Nullable WorldTemplate p_223627_1_) {
      if (p_223627_1_ != null) {
         if (WorldTemplate.Type.MINIGAME == p_223627_1_.field_230655_i_) {
            this.minecraft.showScreen(new RealmsLongRunningMcoTaskScreen(this.field_224415_c, new StartMinigameRealmsAction(this.field_224416_d.field_230582_a_, p_223627_1_, this.func_224407_b())));
         }
