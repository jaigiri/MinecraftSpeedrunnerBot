...
public class RealmsResetWorldScreen extends NotifableRealmsScreen {
   ...
   public void init() {
      this.addButton(new Button(this.width / 2 - 40, func_239562_k_(14) - 10, 80, 20, this.field_224464_j, (p_237959_1_) -> {
         this.minecraft.showScreen(this.field_224457_c);
      }));
      ...
      this.addButton(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(1), func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.generate"), field_237939_A_, (p_237958_1_) -> {
         this.minecraft.showScreen(new RealmsResetNormalWorldScreen(this, this.field_224462_h));
      }));
   ...
   public void func_237952_a_(Runnable p_237952_1_) {
      this.minecraft.showScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new SwitchMinigameRealmsAction(this.field_224458_d.field_230582_a_, this.field_224455_a, p_237952_1_)));
   }
   ...
   private void func_237953_a_(@Nullable String p_237953_1_, @Nullable WorldTemplate p_237953_2_, int p_237953_3_, boolean p_237953_4_) {
      this.minecraft.showScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new ResetWorldRealmsAction(p_237953_1_, p_237953_2_, p_237953_3_, p_237953_4_, this.field_224458_d.field_230582_a_, this.field_224475_u, this.field_237942_L_)));
   }
