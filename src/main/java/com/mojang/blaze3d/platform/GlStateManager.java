...
public class GlStateManager {
	private static final FloatBuffer MATRIX_BUFFER = GLX.make(MemoryUtil.memAllocFloat(16), (p_209238_0_) -> LWJGLMemoryUntracker.untrack(MemoryUtil.memAddress(p_209238_0_)));
	...
	private static final GlStateManager.BooleanState[] LIGHT_ENABLE = IntStream.range(0, 8).mapToObj((p_227620_0_) -> new BooleanState(16384 + p_227620_0_)).toArray(BooleanState[]::new);
	...
	private static final GlStateManager.TextureState[] TEXTURES = IntStream.range(0, 12).mapToObj((p_227616_0_) -> new TextureState()).toArray(TextureState[]::new);
