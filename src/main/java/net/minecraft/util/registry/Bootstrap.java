...
public class Bootstrap {
   ...
   public static Set<String> getTranslationStrings() {
      ...
      addTranslationStrings(Registry.CUSTOM_STAT, (p_218820_0_) -> "stat." + p_218820_0_.toString().replace(':', '.'), set);
   ...
   public static void checkTranslations() {
      if (!alreadyRegistered) {
         ...
         if (SharedConstants.developmentMode) {
            getTranslationStrings().forEach((p_218817_0_) -> LOGGER.error("Missing translations: " + p_218817_0_));
