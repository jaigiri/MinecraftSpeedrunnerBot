...
public class ConnectingScreen extends Screen {
         ...
         public void run() {
            ...
            try {
               ...
               ConnectingScreen.this.minecraft.execute(() -> {
                  ConnectingScreen.this.minecraft.showScreen(new DisconnectedScreen(ConnectingScreen.this.previousGuiScreen, DialogTexts.CONNECTION_FAILED, new TranslationTextComponent("disconnect.genericReason", "Unknown host")));
               });
               ...
               ConnectingScreen.this.minecraft.execute(() -> {
                  ConnectingScreen.this.minecraft.showScreen(new DisconnectedScreen(ConnectingScreen.this.previousGuiScreen, DialogTexts.CONNECTION_FAILED, new TranslationTextComponent("disconnect.genericReason", s)));
               });
            }
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20, DialogTexts.GUI_CANCEL, (p_212999_1_) -> {
         ...
         this.minecraft.showScreen(this.previousGuiScreen);
      }));
   }
