...
public final class Biome {
	...
	public static final Codec<Biome> CODEC = RecordCodecBuilder.create((p_235064_0_) -> p_235064_0_.group(Climate.CODEC.forGetter((p_242446_0_) -> p_242446_0_.climate), Category.CODEC.fieldOf("category").forGetter((p_235087_0_) -> p_235087_0_.category), Codec.FLOAT.fieldOf("depth").forGetter((p_235086_0_) -> p_235086_0_.depth), Codec.FLOAT.fieldOf("scale").forGetter((p_235085_0_) -> p_235085_0_.scale), BiomeAmbience.CODEC.fieldOf("effects").forGetter((p_242444_0_) -> p_242444_0_.effects), BiomeGenerationSettings.CODEC.forGetter((p_242443_0_) -> p_242443_0_.biomeGenerationSettings), MobSpawnInfo.CODEC.forGetter((p_242442_0_) -> p_242442_0_.mobSpawnInfo)).apply(p_235064_0_, Biome::new));
	public static final Codec<Biome> PACKET_CODEC = RecordCodecBuilder.create((p_242432_0_) -> p_242432_0_.group(Climate.CODEC.forGetter((p_242441_0_) -> p_242441_0_.climate), Category.CODEC.fieldOf("category").forGetter((p_242439_0_) -> p_242439_0_.category), Codec.FLOAT.fieldOf("depth").forGetter((p_242438_0_) -> p_242438_0_.depth), Codec.FLOAT.fieldOf("scale").forGetter((p_242434_0_) -> p_242434_0_.scale), BiomeAmbience.CODEC.fieldOf("effects").forGetter((p_242429_0_) -> p_242429_0_.effects)).apply(p_242432_0_, (p_242428_0_, p_242428_1_, p_242428_2_, p_242428_3_, p_242428_4_) -> new Biome(p_242428_0_, p_242428_1_, p_242428_2_, p_242428_3_, p_242428_4_, BiomeGenerationSettings.DEFAULT_SETTINGS, MobSpawnInfo.EMPTY)));
	...
	private final Map<Integer, List<Structure<?>>> biomeStructures = Registry.STRUCTURE_FEATURE.stream().collect(Collectors.groupingBy((p_242435_0_) -> p_242435_0_.getDecorationStage().ordinal()));
		...
		for (int j = 0; j < i; ++j) {
			...
			if (structureManager.canGenerateFeatures()) {
				for (Structure<?> structure : this.biomeStructures.getOrDefault(j, Collections.emptyList())) {
					...
					try {
						structureManager.func_235011_a_(SectionPos.from(pos), structure).forEach((p_242426_8_) -> p_242426_8_.func_230366_a_(worldGenRegion, structureManager, chunkGenerator, rand, new MutableBoundingBox(j1, k1, j1 + 15, k1 + 15), new ChunkPos(l, i1)));
			...
			if (list.size() > j) {
				for (Supplier<ConfiguredFeature<?, ?>> supplier : list.get(j)) {
					...
					try {
						...
						crashreport1.makeCategory("Feature").addDetail("Id", Registry.FEATURE.getKey(configuredfeature.feature)).addDetail("Config", configuredfeature.config).addDetail("Description", () -> configuredfeature.feature.toString());
	...
	public enum Category implements IStringSerializable {
		...
		private static final Map<String, Biome.Category> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Biome.Category::getName, (p_222353_0_) -> p_222353_0_));
	...
	public enum RainType implements IStringSerializable {
		...
		private static final Map<String, Biome.RainType> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Biome.RainType::getName, (p_222360_0_) -> p_222360_0_));
	...
	public enum TemperatureModifier implements IStringSerializable {
		...
		private static final Map<String, Biome.TemperatureModifier> NAME_TO_MODIFIER_MAP = Arrays.stream(values()).collect(Collectors.toMap(Biome.TemperatureModifier::getName, (p_242476_0_) -> p_242476_0_));
	...
	public static class Attributes {
		public static final Codec<Biome.Attributes> CODEC = RecordCodecBuilder.create((p_235111_0_) -> p_235111_0_.group(Codec.floatRange(-2.0F, 2.0F).fieldOf("temperature").forGetter((p_235116_0_) -> p_235116_0_.temperature), Codec.floatRange(-2.0F, 2.0F).fieldOf("humidity").forGetter((p_235115_0_) -> p_235115_0_.humidity), Codec.floatRange(-2.0F, 2.0F).fieldOf("altitude").forGetter((p_235114_0_) -> p_235114_0_.altitude), Codec.floatRange(-2.0F, 2.0F).fieldOf("weirdness").forGetter((p_235113_0_) -> p_235113_0_.weirdness), Codec.floatRange(0.0F, 1.0F).fieldOf("offset").forGetter((p_235112_0_) -> p_235112_0_.offset)).apply(p_235111_0_, Attributes::new));
	...
	static class Climate {
		public static final MapCodec<Biome.Climate> CODEC = RecordCodecBuilder.mapCodec((p_242465_0_) -> p_242465_0_.group(RainType.CODEC.fieldOf("precipitation").forGetter((p_242472_0_) -> p_242472_0_.precipitation), Codec.FLOAT.fieldOf("temperature").forGetter((p_242471_0_) -> p_242471_0_.temperature), TemperatureModifier.CODEC.optionalFieldOf("temperature_modifier", TemperatureModifier.NONE).forGetter((p_242470_0_) -> p_242470_0_.temperatureModifier), Codec.FLOAT.fieldOf("downfall").forGetter((p_242469_0_) -> p_242469_0_.downfall)).apply(p_242465_0_, Climate::new));
